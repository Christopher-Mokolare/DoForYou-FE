...
import { TaskChatPageComponent } from './task-chat-page/task-chat-page.component';
...
export const TASKS_ROUTES: Routes = [
  ...
  { path: 'edit/:taskId', component: PostErrandComponent, canActivate: [authGuard, ProfileCompletionGuard] },
  ...
  { path: 'chat/:taskId', component: TaskChatPageComponent, canActivate: [authGuard] },
